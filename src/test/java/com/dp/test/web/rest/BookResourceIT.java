...
import com.dp.test.domain.Book;
import com.dp.test.repository.BookRepository;
...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().name(DEFAULT_NAME).desc(DEFAULT_DESC);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().name(UPDATED_NAME).desc(UPDATED_DESC);
        return book;
    }
    ...
    void createBook() throws Exception {
        ...
        assertThat(testBook.getDesc()).isEqualTo(DEFAULT_DESC);
    }
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.name(UPDATED_NAME).desc(UPDATED_DESC);
        ...
        assertThat(testBook.getDesc()).isEqualTo(UPDATED_DESC);
    }
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.name(UPDATED_NAME).desc(UPDATED_DESC);
