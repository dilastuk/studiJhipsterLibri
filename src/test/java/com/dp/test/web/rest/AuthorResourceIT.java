...
import com.dp.test.repository.AuthorRepository;
...
class AuthorResourceIT {
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().name(DEFAULT_NAME).desc(DEFAULT_DESC).birth(DEFAULT_BIRTH);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().name(UPDATED_NAME).desc(UPDATED_DESC).birth(UPDATED_BIRTH);
        return author;
    }
    ...
    void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getDesc()).isEqualTo(DEFAULT_DESC);
        assertThat(testAuthor.getBirth()).isEqualTo(DEFAULT_BIRTH);
    }
    ...
    void putNewAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).desc(UPDATED_DESC).birth(UPDATED_BIRTH);
        ...
        assertThat(testAuthor.getDesc()).isEqualTo(UPDATED_DESC);
        assertThat(testAuthor.getBirth()).isEqualTo(UPDATED_BIRTH);
    }
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.desc(UPDATED_DESC);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).desc(UPDATED_DESC).birth(UPDATED_BIRTH);
